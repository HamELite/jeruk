...
<div>
  ...
  <p data-aos="fade-up" data-aos-delay="500" className="text-sm">Jeruk adalah buah sehat yang kaya akan vitamin C, serat, dan antioksidan. Konsumsi jeruk membantu memperkuat sistem kekebalan tubuh, memperbaiki pencernaan, dan melawan radikal bebas. Dengan kalori rendah dan rasa segar, jeruk adalah pilihan sempurna untuk camilan sehat sehari-hari.</p>
...
<div data-aos="zoom-in">
  <img src={OrangeImg} alt="Not Found" className="relative z-10 w-[400px] img-shadow" />
        ...
        </div><div className="md:hidden "></div>

          </div>
          <h1 data-aos="fade" data-aos-delay="600" data-aos-duration="1800" className="large-text">
  Orange
</h1>
{sidebar && ( 
