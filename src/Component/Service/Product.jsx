...
import HeroImg from '../../assets/jeruk.jpg';
...
const Product = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    country: '',
    paymentMethod: '',
    purchasedItem: 'Buah Jeruk 1 Pack',
  });
  ...
  return (
    <div data-aos="fade-up" data-aos-duration="300" className="container">
      <div className="header">
        <h1 data-aos="zoom-in" data-aos-duration="400" className="text-3xl font-bold text-white bg-primaryDark rounded-[10px]">JERUK</h1>
      </div>
      <div className="habitat-info flex flex-col md:flex-row items-start mt-4 mb-6">
        ...
        <div className="info-text text-md">
          <h2 data-aos="zoom-in" data-aos-duration="500" className="text-2xl font-bold mb-2 text-secondary">Habitat Alami Jeruk</h2>
          <p data-aos="fade-left" data-aos-duration="600">
          Buah jeruk umumnya tumbuh di daerah subtropis dan tropis dengan iklim yang hangat. Mereka membutuhkan sinar matahari yang cukup dan suhu yang stabil untuk tumbuh dengan baik. Habitat alami jeruk dapat ditemukan di berbagai belahan dunia, termasuk Asia, Amerika, dan Mediterania.
          </p>
          <p data-aos="fade-left" data-aos-duration="600">
          Pohon jeruk biasanya tumbuh di tanah yang subur dan memiliki drainase yang baik. Mereka lebih suka tanah yang lembab tetapi tidak tergenang air. Selain itu, jeruk juga dapat tumbuh dengan baik di tanah berpasir atau berlumpur.
          </p>
        </div>
      </div>
      <div data-aos="zoom-in" data-aos-duration="500" className="product mt-6">
        ...
        <div className="product-details">
          <h1 className="text-secondary">BUAH JERUK | JERUK SEGAR 1 PACK</h1>
